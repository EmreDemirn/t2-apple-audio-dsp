...
echo "Copying 10-t2_161_mic.conf to /etc/pipewire/pipewire.conf.d"
sudo cp  config/10-t2_161_mic.conf /etc/pipewire/pipewire.conf.d
...
sudo chmod o+r /usr/share/pipewire/devices/apple/*.wav
